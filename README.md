...
| **NAME**      | YEAR | SIZE                                                                                                                         | MODALITIES                                                                                                                                                                | ROBOTS | UNI / ORG             | Links                                                                                                                                                                                                                                    |
| ------------- | ---- | ---------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------ | --------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **RoboTurk**  | 2019 | ***Real*** <br>🕹️ 2144 demos.<br><br>***Sim*** <br>🕹️ 1070 Sawyer<br>PickPlace<br>🕹️1147 <br>Sawyer<br>NutAssembly demos. | ***Real***  <br>🖼️ Multiple camera views and depth data<br><br>🤖 control data from the user and joint data from the robot<br> <br> ***Sim***<br> 🤖 Robot state, action | Sawyer | Stanford              |   [🌐&nbsp;Website](https://roboturk.stanford.edu/index.html)<br>📄[Paper](https://arxiv.org/abs/1811.02790)<br>💾[Data Real](https://roboturk.stanford.edu/dataset_real.html)<br>💾 [Data Sim](https://roboturk.stanford.edu/dataset_sim.html) |
...
| ---------------- | ---- | -------------------------------------------- | -------------------- | ------------------------- | --------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **LIBERO**       | 2023 | ![](images/libero.gif)                       | RoboSuite            | Panda                     | UT Austin, Tsinghua Univers | [📄 Paper](https://arxiv.org/abs/2306.03310) [  🌐&nbsp;Website](https://libero-project.github.io/datasets) [🛠️ Code](https://libero-project.github.io/datasets) |
| **BEHAVIOR-1K**  | 2022 | ![](images/behavior.gif)                     | iGibson 2.0 + Robots | Panda, Fetch, TurtleBot   | Stanford                    | [📄 Paper](https://arxiv.org/abs/2403.09227) [  🌐&nbsp;Website](https://behavior.stanford.edu/) [🛠️ Code](https://behavior.stanford.edu/)                       |
| **CALVIN**       | 2022 | ![](images/calvin.gif)                       | Real Franka robots   | Panda                     | TU Dresden                  | [📄 Paper](https://arxiv.org/abs/2112.03227) [ 🌐&nbsp;Website](http://calvin.cs.uni-freiburg.de/) [🛠️ Code](https://github.com/mees/calvin)                     |
| **Habitat 2.0**  | 2021 | ![](images/habitat_demonstration_videos.gif) | Habitat Sim          | LoCoBot, Fetch            | FAIR, Georgia Tech          | [📄 Paper](https://arxiv.org/abs/2106.14405) [  🌐&nbsp;Website](https://aihabitat.org/docs/habitat2/) [🛠️ Code](https://aihabitat.org/docs/habitat2/)           |
| **ALFRED**       | 2020 | ![](images/habitat_demonstration_videos.gif) | AI2-THOR             | Virtual agents (AI2-THOR) | Allen Institute for AI      | [📄 Paper](https://arxiv.org/abs/1912.01734) [ 🌐&nbsp;Website](https://askforalfred.com/) [🛠️ Code](https://askforalfred.com/)                                  |
| **RLBench**      | 2020 | ![](images/habitat_demonstration_videos.gif) | PyRep                | Panda                     | Imperial College London     | [📄 Paper](https://arxiv.org/abs/1909.12271) [ 🌐&nbsp;Website](https://sites.google.com/view/rlbench) [🛠️ Code](https://github.com/stepjam/RLBench)             |
| **BEHAVIOR-100** | 2020 | ![](images/habitat_demonstration_videos.gif) | iGibson              | Fetch, LoCoBot            | Stanford                    | [📄 Paper](https://arxiv.org/abs/2108.03332) [ 🌐&nbsp;Website](https://behavior.stanford.edu/) [🛠️ Code](https://github.com/StanfordVL/behavior)                |
| **Meta-World**   | 2019 | ![](images/habitat_demonstration_videos.gif) | MuJoCo               | Sawyer                    | UC Berkeley                 | [📄 Paper](https://arxiv.org/abs/1910.10897) [ 🌐&nbsp;Website](https://meta-world.github.io/) [🛠️ Code](https://github.com/Farama-Foundation/Metaworld)         |
| **VirtualHome**  | 2018 | ![](images/habitat_demonstration_videos.gif) | Unity3D              | Virtual agents            | MIT, Stanford               | [📄 Paper](https://arxiv.org/abs/1806.07011) [ 🌐&nbsp;Website](http://virtual-home.org/) [🛠️ Code](http://virtual-home.org/)                                    |
...
| ----------------------------------------------------------------- | ---- | --------------------- | ---------------------- | ------ | -------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **RoboArena**                                                     | 2025 | 🖼️ Vision, 🤖 Action | DROID                  | Panda  | UC Berkeley, <br>Stanford, <br>UWashington, <br>UMontreal, <br>NVIDIA, <br>UPenn, <br>UT Austin, <br>Yonsei U. | [📄Paper](https://arxiv.org/abs/2506.18123)<br>[ 🌐&nbsp;Website](https://robo-arena.github.io/)<br>[🛠️Code](https://github.com/robo-arena/roboarena)                      |
| **FMB**<br>(**F**unctional <br>**M**anipulation<br>**B**enchmark) | 2024 | 🖼️ Vision, 🤖 Action | 3D printed objects     | Panda  | UC Berkeley                                                                                                    | [📄 Paper](https://arxiv.org/abs/2401.08553)<br>[ 🌐&nbsp;Website](https://functional-manipulation-benchmark.github.io/)<br>[🛠️Code](https://github.com/rail-berkeley/fmb) |
| **FurnitureBench**                                                | 2023 | 🖼️ Vision, 🤖 Action | *** 3D printed objects | Panda  | UC Berkeley,<br>KAIST                                                                                          | [📄Paper](https://arxiv.org/abs/2305.12821)<br>[ 🌐&nbsp;Website](https://clvrai.github.io/furniture-bench/)<br>[🛠️Code](https://clvrai.github.io/furniture-bench/)        |
