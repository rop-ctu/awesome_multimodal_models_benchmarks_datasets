...
| ---------------- | ---- | ----------------------------------------------------------------------------------- | -------------------- | ------------------------- | --------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **LIBERO**       | 2023 | ![](images/libero_demonstration_videos.gif) | RoboSuite            | Panda                     | UT Austin, Tsinghua Univers | [📄 Paper](https://arxiv.org/abs/2306.03310) [🌐 Website](https://libero-project.github.io/datasets) [🛠️ Code](https://libero-project.github.io/datasets) |
